        ...
        if (currentUser?.email) {
            ...
            try {
                ...
                toast({
                    ...
                    description: 'Could not load your child\'s fee information.',
                    variant: 'destructive'
                });
            }
        }
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>View your child's fee history and make payments online.</CardDescription>
      </CardHeader>
      <CardContent>
        {loading ? (
            ...
            <p>No fee information found for your child's account.</p>
        )}
      </CardContent>
    </Card>
  );
