...
import { Home, Users, UserPlus, FileText, BarChart2, Library, Bus, Hotel, LogOut, Loader2 } from 'lucide-react';
...
const navItems = [
  ...
  { href: '/admin/dashboard/hostel', label: 'Manage Hostel', icon: Hotel },
];
