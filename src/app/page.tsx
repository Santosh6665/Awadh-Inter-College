...
const carouselImages = [
  { src: "/hero-1.jpg", alt: "College Campus", hint: "college campus" },
  { src: "/hero-2.jpg", alt: "Students learning in a classroom", hint: "students classroom" },
  { src: "/hero-3.jpg", alt: "University library with students", hint: "university library" },
  { src: "/hero-4.jpg", alt: "Graduation ceremony", hint: "graduation ceremony" },
  { src: "/hero-5.jpg", alt: "Students participating in a sports event", hint: "students sports" },
];
